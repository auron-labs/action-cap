...
- `scripts/` — Helper scripts: `package-edge.mjs` builds the Edge store zip; `package-firefox.mjs` builds the Firefox store zip; `generate-edge-assets.py` generates store promotional images.
